...
function ContractBoxGui:create_contract_box()
	...
	if contact_data then
		...
		self._contact_image = self._contract_panel:bitmap( { name = "contact_image", texture="guis/textures/contact_vlad", w = 100, h = 128, x=5, y=-30, texture_rect={0,0,100,128}, layer=1 } )
